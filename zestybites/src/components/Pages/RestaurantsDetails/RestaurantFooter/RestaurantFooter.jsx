...
import backgroundImage from './images/backgroundimage.jpg'; // Import background image
import paymentOptions from './images/payment-options.jpg'; // Import payment options image
